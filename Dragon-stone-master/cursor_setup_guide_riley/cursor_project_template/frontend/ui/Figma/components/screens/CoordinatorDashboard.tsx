...
import { Search, Filter, Eye, Check, X, MessageSquare, Calendar, Users, Clock, Settings, Bell } from "lucide-react";
...
export function CoordinatorDashboard({ onViewDocument, onAlertsPress, onSettingsPress }: CoordinatorDashboardProps) {
      ...
      <div className="fixed top-0 left-0 right-0 z-20 backdrop-blur-md p-6 pb-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-[#58398B] mb-2">Claims</h1>
          </div>
        </div>
      </div>
            ...
            <div className="space-y-4">
              {filteredLogs.length > 0 ? (
                filteredLogs.map((log) => (
                  <SDCard key={log.id} padding="lg" variant="elevated" className="hover:shadow-lg transition-shadow">
                    <div className="space-y-4">
                      {/* Header */}
