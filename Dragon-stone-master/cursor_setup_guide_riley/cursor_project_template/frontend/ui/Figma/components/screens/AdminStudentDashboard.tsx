...
import { Plus, Clock, Award, TrendingUp, Users, Calendar, Eye, Bell, Settings } from "lucide-react";
      ...
      <div className="fixed top-0 left-0 right-0 z-20 backdrop-blur-md p-4 pb-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center">
            <h1 className="text-[#58398B] mb-1">{getGreeting()}, {user?.name?.split(' ')[0]}</h1>
            <p className="text-[#58398B]/70 text-sm">Ready to make a difference today?</p>
          </div>
        </div>
      </div>

      {/* Scrollable Content Container with Glassmorphic Card */}
      <div className="relative z-10 max-w-4xl mx-auto p-6 pt-[140px] pb-24">
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-6 space-y-6 mb-6">
          {/* Stats Overview */}
          <SDCard variant="elevated" padding="lg" className="bg-white/90">
          ...
          {/* Admin Badge */}
          <SDCard padding="md" className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border-purple-200">
            <div className="flex items-center gap-3">
              <div className="p-2 bg-purple-500/20 rounded-full">
                <Award className="h-5 w-5 text-purple-600" />
              </div>
              <div className="flex-1">
                <p className="font-medium text-foreground">Admin Student</p>  
                <p className="text-sm text-muted-foreground">You have special permissions to manage activities</p>
              </div>
            </div>
          </SDCard>
