...
import { Calendar, MapPin, Clock, Users, Plus, X, Search, Filter, ArrowUpDown, CheckCircle, Settings, Bell } from "lucide-react";
...
export function EventsScreen({ onBack, onAlertsPress, onSettingsPress }: EventsScreenProps = {}) {
  const { user } = useAuth();
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 right-0 z-20 backdrop-blur-md p-4 pb-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-3">
            <h1 className="text-[#58398B] mb-3">Events</h1>
            
            {/* Glide Segmented Control - Centered */}
            <div className="flex justify-center">
              <div className="relative inline-flex bg-[#58398B]/10 rounded-lg p-1 backdrop-blur-sm">
                {/* Sliding background indicator */}
                <div 
                  className="absolute top-1 bottom-1 left-1 rounded-md bg-[#58398B] shadow-md transition-transform duration-300 ease-out"
                  style={{
                    width: 'calc(50% - 4px)',
                ...
                <button
                  ...
                  className={`relative z-10 px-6 py-2 rounded-md transition-colors duration-300 ${
                    viewMode === 'create'
                      ? 'text-white'
                      : 'text-[#58398B]/70 hover:text-[#58398B]'
                  }`}
                >
                  Create
                </button>
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6 pt-[200px] pb-24">
